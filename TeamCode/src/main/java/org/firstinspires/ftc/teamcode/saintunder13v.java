...
@Autonomous
public class saintunder13v extends LinearOpMode
{
    DcMotor motorFLeft;
    DcMotor motorBRight;
    DcMotor motorBLeft;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        this.sleep(10000);
        motorBLeft.setPower(0.37);
        motorFLeft.setPower(0.37);
        motorBRight.setPower(0.37);
        motorBLeft.setPower(0.37);
        this.sleep(1500);
        ...
        shooting.setPower(0.58); //54 1 ball 13.3 //12.8v-0.58 2 balls
        this.sleep(4200);
        eating.setPower(0.73);
        this.sleep(2950);
