...
public class another extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        motorBRight.setTargetPosition(motorBRight.getCurrentPosition()+600);
        motorBLeft.setTargetPosition(motorBLeft.getCurrentPosition()+600);
        motorFLeft.setTargetPosition(motorFLeft.getCurrentPosition()+600);
        motorFRight.setTargetPosition(motorFRight.getCurrentPosition()+600);
