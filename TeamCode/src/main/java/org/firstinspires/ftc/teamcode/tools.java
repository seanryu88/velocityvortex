 ...
 */
@Autonomous(name ="tools", group = "Teamcode")
public class tools extends LinearOpMode
{
    DcMotor motorFLeft;
    DcMotor motorBRight;
    DcMotor motorBLeft;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        VectorF trans = navOffWall(tools.getPose().getTranslation(), Math.toDegrees(angles.get(0)) - 90, new VectorF(300, 0, 0));
        ...
        do
        {
            ...
            {
                trans = navOffWall(tools.getPose().getTranslation(), Math.toDegrees(angles.get(-0)) - 90, new VectorF(300, 0, 0));
            }
            idle();
