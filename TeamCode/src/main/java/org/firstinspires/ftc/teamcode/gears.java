 ...
 */
@Autonomous(name ="gears", group = "Teamcode")
public class gears extends LinearOpMode
{
    DcMotor motorFLeft;
    DcMotor motorBRight;
    DcMotor motorBLeft;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        motorBRight.setTargetPosition(1100);
        motorFRight.setTargetPosition(1100);

        motorBLeft.setTargetPosition(0);
        motorFLeft.setTargetPosition(0);
        ...
        VectorF trans = navOffWall(Gears.getPose().getTranslation(), Math.toDegrees(angles.get(0)) - 90, new VectorF(300, 0, 0));
        ...
        do
        {
            ...
            {
                trans = navOffWall(Gears.getPose().getTranslation(), Math.toDegrees(angles.get(0)) - 90, new VectorF(300, 0, 0));
            }
            idle();
