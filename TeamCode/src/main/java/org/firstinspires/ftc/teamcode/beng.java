...
/**
 * Created by seanryu on 21/04/2017.
 */
@Autonomous(name = "beng", group = "teamcode")
public class beng extends LinearOpMode
{
    DcMotor motorFLeft;
    DcMotor motorBRight;
    DcMotor motorBLeft;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        do
        {
            ...
            {
                trans = navOffWall(gears.getPose().getTranslation(), Math.toDegrees(angles.get(1)) - 90, new VectorF(0, 300, 0));
            }
            idle();
