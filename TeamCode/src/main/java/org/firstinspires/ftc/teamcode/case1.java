 ...
 */
@Autonomous(name ="case1", group = "Teamcode")


//suppose the translation is positive
//suppose we are in the red alliance
...
public class case1 extends LinearOpMode
{
    ...
    DcMotor eating2;
    DcMotor railL, railR;
    Servo   beaconr, beaconl;
    Servo   clunk;
    ColorSensor color1;
    OpticalDistanceSensor stick;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        VectorF trans = navOffWall(gears.getPose().getTranslation(), Math.toDegrees(angles.get(1)) - 90, new VectorF(300, 0, 0));
        ...
        do
        {
            ...
            {
                trans = navOffWall(gears.getPose().getTranslation(), Math.toDegrees(angles.get(1)) - 90, new VectorF(300, 0, 0));
            }
            idle();
        } while (opModeIsActive() && Math.abs(-trans.get(1)) > 30);
        ...
        if (stick.getRawLightDetected()>0)
        {
            beacon();
        }
